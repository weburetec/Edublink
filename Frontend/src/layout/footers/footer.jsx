                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="inner text-center">
                                <p>Copyright {new Date().getFullYear()} <a href="https://1.envato.market/AoJezj" rel="noreferrer" target="_blank">LearnX Study</a> Designed By <a href="https://www.weburetech.com" rel="noreferrer" target="_blank">Webure Technologies</a>. All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
